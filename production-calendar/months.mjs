...
const august = {
  ...
  cells: {
    19: { stage: 'BUILD', badge: 'TODAY', tags: [
      { co: 'VAY', who: 'AL', text: 'JNP FR PAGES ×8', status: 'wip' },
      { co: 'VAY', who: 'AL', text: '14:30 JNP REVIEW', status: false },
      { co: 'WPP', who: 'AL', text: 'P11 EDITS BRIEF 10:30', status: false },
    ...
    21: { stage: 'FEEDBACK', badge: 'EXTENDED +2 WKS', badgeBg: '#DCEFA6', tags: [
      { co: 'WPP', who: 'AL', text: 'WK04 ENDS · RUNS TO 4 SEP', status: false },
      { co: 'VAY', who: 'AL', text: 'TIMESHEET' } ],
      warns: ['Blocked 12:00–17:00 · collecting James'] },
    22: { stage: 'SHOOT', badge: 'SHOOT DAY', tags: [
      { co: 'REACT', who: 'F2', text: 'RED CARD · SHOOT' } ],
      warns: ["Rocco 10:00 → Sun 14:00, party 20:30. Hand this one over."] },
    23: { stage: 'EDIT', tags: [ { co: 'REACT', who: 'F2', text: 'RED CARD · EDIT D1' } ], notes: ['You free from 14:00'] },
    24: { stage: 'EDIT', tags: [
      { co: 'REACT', who: 'F2', text: 'RED CARD · EDIT D2 → V1' },
    ...
    25: { stage: 'BUILD', tags: [
      ...
      { co: 'WPP', who: 'F3', text: '40 FEET AWAY · BUILD', proposed: P } ], notes: ['Vayner in office'] },
    26: { stage: 'SHOOT', badge: 'SHOOT DAY', tags: [
      { co: 'WPP', who: 'AL', text: 'FORAGING SHOOT · ALL DAY' } ], notes: ['Already held in your diary'] },
    27: { stage: 'EDIT', tags: [
    ...
    28: { stage: 'LIVE', badge: 'GOES LIVE', tags: [
      { co: 'REACT', who: 'F2', text: 'EP BAG CHECK · LIVE' } ],
      warns: ['You are away — F2 posts and monitors'] },
    29: { away: true, notes: ["GIRLS' GETAWAY"] },
    30: { away: true, notes: ['Back 12:00'] },
    31: { stage: 'BUILD', tags: [
      { co: 'REACT', who: 'AL', text: 'HURLING + MATCHDAY OSG' },
  ...
  footers: [
    ...
    { title: 'TWO CLASHES TO FIX NOW', bg: '#F4E7B0', body: '<strong>Sat 22</strong> — Red Card shoot against Rocco and a party. <strong>Thu 27</strong> — Halima&rsquo;s print-ready files due the day you leave at 18:00. Both need a person or a new date.' },
  ],
};
...
const september = {
  ...
  cells: {
    1: { stage: 'BUILD', tags: [
      { co: 'REACT', who: 'AL', text: 'FIRST WEEK · OSG + BOARD' },
    ...
    3: { stage: 'BUILD', tags: [
      ...
      { co: 'WPP', who: 'F3', text: "WHAT'S IN MY BAG · BUILD", proposed: P } ], notes: ['Therapy 16:00 · Vayner office'] },
    ...
    7: { stage: 'EDIT', tags: [ { co: 'REACT', who: 'AL', text: 'PRE-PRO V2 / V3' } ], notes: ['Editorial weekly 11:00 · Vayner office'] },
    ...
    9: { stage: 'BUILD', tags: [
      { co: 'WPP', who: 'F3', text: 'DRESSED TO ELEVENS · BUILD', proposed: P },
      { co: 'WPP', who: 'F2', text: 'WHERE THE SUN GOES · RECCE', proposed: P } ] },
    10: { stage: 'SHOOT', badge: 'SHOOT DAY', tags: [
      { co: 'WPP', who: 'F2', text: 'WHERE THE SUN GOES · SHOOT', proposed: P },
      { co: 'WPP', who: 'F3', text: '40 FEET AWAY · SHOOT', proposed: P } ], notes: ['Therapy 16:00'] },
    11: { stage: 'SHOOT', badge: 'SHOOT DAY', tags: [
      { co: 'REACT', who: 'AL', text: 'EXPLAIN HURLING' },
      { co: 'REACT', who: 'AL', text: 'MATCHDAY RITUALS' } ], notes: ['Parnell Park, Dublin · 18:45'] },
    12: { stage: 'SHOOT', badge: 'SHOOT DAY', tags: [
      { co: 'REACT', who: 'AL', text: 'FIRST WEEK PROMISES' } ], notes: ["UCC Freshers' Festival, Cork"] },
    13: { stage: 'EDIT', tags: [
      { co: 'REACT', who: 'AL', text: 'HURLING + MATCHDAY · EDIT' },
      { co: 'REACT', who: 'F2', text: 'FIRST WEEK · EDIT' } ] },
    14: { stage: 'EDIT', tags: [ { co: 'REACT', who: 'F2', text: 'ALL THREE · EDIT' } ], notes: ['Editorial weekly 11:00 · Vayner office'] },
    15: { stage: 'EDIT', tags: [ { co: 'REACT', who: 'F2', text: 'ALL THREE · FINAL PASS' } ], notes: ['Vayner in office'] },
    ...
    17: { stage: 'FEEDBACK', badge: 'LAST DAY', badgeBg: '#F8CFA4', tags: [
      { co: 'WPP', who: 'AL', text: 'P11 · HAND TO F2 / F3', proposed: P },
    ...
    29: { stage: 'BUILD', badge: 'BACK', badgeBg: '#DCEFA6', tags: [
      { co: 'WPP', who: 'AL', text: 'REVIEW WHAT F2 / F3 SHIPPED', proposed: P } ], notes: ['Vayner in office'] },
    30: { stage: 'EDIT', tags: [ { co: 'WPP', who: 'F2', text: 'P11 BACKLOG · EDIT', proposed: P } ] },
  },
  footers: [
    ...
    { title: 'THE BREAK IS SHORTER NOW', bg: '#DCEFA6', body: 'With Paris out you are only gone <strong>18–28 Sep</strong>. Production restarts on the 29th rather than in mid-October — which is what makes the Pixel backlog recoverable.' },
  ],
};
...
const october = {
  ...
  cells: {
    1: { stage: 'BUILD', tags: [ { co: 'WPP', who: 'F3', text: 'P11 · BUILD BLOCK', proposed: P } ], notes: ['Therapy 16:00'] },
    ...
    3: { stage: 'SHOOT', badge: 'SHOOT DAY', tags: [
      { co: 'WPP', who: 'AL', text: 'MADE IN THE DETAILS · ATELIER', proposed: P } ], notes: ["Weekend shoot — you said you don't mind"] },
    4: { stage: 'EDIT', tags: [ { co: 'WPP', who: 'F3', text: 'MADE IN THE DETAILS · EDIT', proposed: P } ] },
    ...
    9: { stage: 'EDIT', tags: [ { co: 'WPP', who: 'F2', text: 'P11 · V2 REVISIONS', proposed: P } ], notes: ['Vayner timesheet'] },
  ...
  footers: [
    { title: 'OCTOBER IS THE PAYBACK MONTH', body: 'With Paris gone this is a clear month. The Pixel backlog F2 and F3 built while you were away gets reviewed, revised and shipped, and Halima&rsquo;s French site starts.' },
    { title: '13–31 LEFT OPEN ON PURPOSE', dashed: true, body: 'Your diary past mid-October is only standing meetings, and the Re:act engagement may not run past September. Not worth filling in until you name F2 and F3 and confirm whether Re:act renews.' },
  ],
};
